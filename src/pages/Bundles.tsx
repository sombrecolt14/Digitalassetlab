...
export default function Bundles() {
  usePageMeta(
    "Instagram Reels Template Bundle — Complete Creator Bundle ₹530 | Digital Asset Lab",
    "The Complete Creator Bundle: 6200+ Instagram Reel templates, 500+ hooks, 300+ transitions and a viral strategy guide. One-time ₹530, instant delivery."
  );
